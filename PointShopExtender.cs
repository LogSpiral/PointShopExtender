...
public class PointShopExtender : Mod
{
    ...
    public override void Load()
    {
        ...
        UpdateFocusedElementMethodNull = typeof(SilkyUIInputState).GetMethod("UpdateFocusedElement", BindingFlags.Instance | BindingFlags.NonPublic, []);
    ...
    private static MethodInfo UpdateFocusedElementMethodNull { get; set; }
    ...
    public static void UpdateFocusedElementCall()
    {
        if (InputState is not { } inputState)
            return;
        UpdateFocusedElementMethod?.Invoke(inputState, []);
    }
}
